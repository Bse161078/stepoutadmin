...
let searchbyname=""
export default class FreezeVenues extends React.Component {
  constructor(props) {
    super(props);
      this.state = {
      users: [],
  ...
  render() {
    console.log("searchvenue",this.state.allVenue)
    return (
      ...
      <table  width={1000} style={{tableLayout:'auto'}} class="table table-striped table-bordered"  >
        ...
        <tr>
          ...
          <Slider style={{width:"100px"}} arrows={false} infinite={true} adaptiveHeight={true} autoplaySpeed={2000} autoplay={true}  touchMove={true} dots={true}>
            ...
            {venue.Videos&&venue.Videos.map((cimage)=>{
            return(
